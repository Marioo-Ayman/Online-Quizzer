        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('admin.dashboard') }}" class="logo">
                    <span class="logo flex justify-center align-middle text-white">
                        <h1>Quiz</h1>
                     </span>
                </a>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{ view('admin.sections.updateprofile') }}"><i class="ri-user-line align-middle me-1"></i>
                        Profile</a>
